...
class SpatialBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, window_size=7,
                 mlp_ratio=4.,  drop=0.,  drop_path=0., dynamic=False, inhomogeneous=False, 
                 inhomo_head=None, act_layer=nn.GELU):
        super().__init__()
        self.dim = dim
...
class DWNet(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 ape=False, patch_norm=True, use_checkpoint=False, dynamic=False, 
                 inhomogeneous=False, inhomo_heads=None, **kwargs):
        super().__init__()
