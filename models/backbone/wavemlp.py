...
class WaveBlock(nn.Module):
    """
    Similar to one Transformer block, replace Self-attention with PATM
    """
...
class WaveNet(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 layers=[2, 2, 4, 2], mlp_ratios = [4, 4, 4, 4], embed_dims = [64, 128, 320, 512],
