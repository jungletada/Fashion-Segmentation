...
for num in range(1, num_images + 1):
    json_name = '../data/DeepFashion2/annos_train/' + str(num).zfill(6)+'.json'
    image_name = '../data/DeepFashion2/train/image/' + str(num).zfill(6)+'.jpg'
...
json_name = '../data/annotations/Deepfashion2_train.json'
